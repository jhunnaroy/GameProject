      ...
      <div className="w-full max-w-4xl bg-slate-800 rounded-3xl p-6 md:p-10 shadow-xl">
        ...
        <div className="mt-10 flex flex-col md:flex-row gap-4">
          ...
          <button
            ...
            className="flex-1 bg-green-600 hover:bg-green-700 py-4 rounded-xl font-bold text-lg"
          >
            Play Again
          </button>
          ...
          <button
            ...
            className="flex-1 bg-blue-600 hover:bg-blue-700 py-4 rounded-xl font-bold text-lg"
          >
            Back To Home
          </button>
